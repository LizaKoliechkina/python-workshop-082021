...
class FibonacciIterable:  # we need Iterable class to create multiple custom iterators
    def __init__(self, start, end):
        self.start = start
        self.end = end
...
class Call:
    ...
    def __call__(self, *args, **kwargs):
        for _ in self.it(start=self.start, end=self.end):  # not important var, _ - dummy name
            pass
...
if __name__ == '__main__':
    ...
    fibonacci_generator_lazy = FibonacciGeneratorOptimized  # best option!
